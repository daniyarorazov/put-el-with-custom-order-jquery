    ...
    function updateHrLinesOrders() {
        ...
        for (let i = 0; i < hrLinesOrders.length; i++) {
            ...
            el.addEventListener('click', () => {
                if (i != 0 && $(el).attr("class") != "activeHrTxtAdd") {
                    $(el).css("color", "#000");
